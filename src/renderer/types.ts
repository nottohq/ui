...
export type NottoChildren = string | number | NottoNode | Array<string | number | NottoNode>;

export type ActionHandler = (payload?: unknown) => void;

export type ActionRegistry = Record<string, ActionHandler>;

export type IconRegistry = Record<string, ComponentType<SVGProps<SVGSVGElement>>>;
