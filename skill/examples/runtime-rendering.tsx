      ...
      children: [
        {
          ...
          children: [{ type: "Icon", props: { name: "save", size: "sm" } }, "Save"],
        },
        {
          type: "Button",
          props: { variant: "outline", tone: "neutral", action: "cancel" },
          children: [{ type: "Icon", props: { name: "cancel", size: "sm" } }, "Cancel"],
        },
      ],
    },
  ],
  ...
  return (
    <NottoRenderer
      ...
      onError={(err: RendererError) => {
        console.error(`[notto] ${err.kind} at ${err.path.join(".") || "(root)"}: ${err.message}`);
      }}
